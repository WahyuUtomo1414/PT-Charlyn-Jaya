<x-layout.app>
    ...
    <section
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-10">
            <h1 class="text-4xl font-black tracking-tight text-white mb-6">{{ $service['title'] }}</h1>
            ...
            <div
                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="prose prose-slate lg:prose-lg text-slate-600 mb-8">
                        <p class="font-medium text-lg text-slate-700">{{ $service['description'] }}</p>
                    </div>
                    ...
                    <a href="#penawaran"
                        ...
                        Minta Penawaran <i class="fa-solid fa-arrow-right text-secondary text-sm"></i>
                    </a>
                </div>
