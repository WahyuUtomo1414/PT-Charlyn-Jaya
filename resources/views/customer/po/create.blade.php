<x-layout.app>
    ...
    <section
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-10">
            <h1 class="text-4xl font-black tracking-tight text-white mb-6">Buat <span class="text-secondary">Purchase
                    Order</span></h1>
            <p class="text-lg text-slate-300 max-w-3xl mx-auto font-medium">Lengkapi dokumen PO untuk melanjutkan proses
                kerja sama.</p>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto align-top space-y-8">
            ...
            <div class="bg-white p-8 sm:p-10 rounded-3xl shadow-sm border border-slate-100">
                <div class="mb-8 border-b border-slate-100 pb-6">
                    ...
                    <p class="mt-2 text-slate-500 text-sm font-medium">Lengkapi dokumen PO resmi perusahaan Anda di
                        bawah ini.</p>
                </div>
                ...
                <form action="{{ route('po.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            <label for="no_po" class="block text-sm font-bold text-slate-700 mb-2">Nomor PO
                                (Otomatis)</label>
                            <div class="relative">
                                <input type="text" id="no_po" name="no_po" value="{{ old('no_po', $no_po) }}"
                                    readonly
                        ...
                        <!-- Upload File PO -->
                        <div class="col-span-1 md:col-span-2">
                            <label for="file_po" class="block text-sm font-bold text-slate-700 mb-2">Upload Dokumen PO
                                <span class="text-red-500">*</span></label>
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                <input type="file" id="file_po" name="file_po" required accept=".pdf,.doc,.docx"
                            ...
                            <p x-show="fileName" class="mt-2 text-xs text-slate-500">File dipilih: <span
                                    class="font-semibold" x-text="fileName"></span></p>
                    ...
                    <!-- Actions -->
                    <div class="border-t border-slate-100 pt-12 flex flex-col sm:flex-row justify-end gap-3">
