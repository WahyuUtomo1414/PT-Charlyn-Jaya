<x-layout.app>
    ...
    <section class="relative bg-primary pt-32 pb-24 sm:pt-40 sm:pb-32 overflow-hidden isolate border-b-2 border-slate-100">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-10">
            <h1 class="text-4xl font-black tracking-tight text-white mb-6">Masuk ke <span
                    class="text-secondary">Akun</span></h1>
            <p class="text-lg text-slate-300 max-w-3xl mx-auto font-medium">Silakan masuk untuk melanjutkan ke halaman
                Anda.</p>
        </div>
    </section>
